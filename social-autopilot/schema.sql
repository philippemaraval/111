CREATE TABLE IF NOT EXISTS proposals (
  ...
  x_media_url TEXT,
  instagram_publish_mode TEXT NOT NULL DEFAULT 'automatic',
  instagram_first_comment TEXT,
  instagram_location TEXT,
  instagram_link TEXT,
  instagram_share_to_feed INTEGER NOT NULL DEFAULT 1,
  instagram_user_tags TEXT,
  instagram_music TEXT,
  instagram_sticker_text TEXT,
  instagram_products TEXT,
  instagram_topics TEXT,
  instagram_other TEXT,
  instagram_thumbnail_offset INTEGER,
  tiktok_publish_mode TEXT NOT NULL DEFAULT 'automatic',
  tiktok_mentions TEXT,
  tiktok_music TEXT,
  tiktok_effects TEXT,
  tiktok_thumbnail_offset INTEGER,
  published_at TEXT,
  error TEXT
);
