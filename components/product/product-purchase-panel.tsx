    ...
    <aside className="sticky top-32 py-5 lg:py-8">
      ...
      {neighborhood.isAvailable ? (
        <div className="mt-8">
          ...
          <details className="mt-8 border-t border-navy/10 py-4"><summary className="flex cursor-pointer list-none items-center justify-between text-sm font-bold">Coupe & entretien <ChevronDown className="h-4 w-4" /></summary><p className="pt-3 text-sm leading-6 text-navy/55">Coupe droite tubulaire sans coutures latérales, disponible du S au XL. Le textile supporte un lavage machine à 40 °C ; pour préserver l’impression, nous recommandons 30 °C sur l’envers, avec des couleurs similaires. Séchage à basse température, sans javel ni nettoyage à sec. Repassage à température moyenne, sur l’envers.</p></details>
          <details className="border-y border-navy/10 py-4"><summary className="flex cursor-pointer list-none items-center justify-between text-sm font-bold">Composition & démarche <ChevronDown className="h-4 w-4" /></summary><p className="pt-3 text-sm leading-6 text-navy/55">T-shirt blanc Fruit of the Loom Valueweight SC230 (61-036-0), 100 % coton, 165 g/m², col rond côtelé coton/Lycra® et doubles coutures aux manches et à la base. Chaque visuel est imaginé à Marseille et proposé en série courte.</p></details>
