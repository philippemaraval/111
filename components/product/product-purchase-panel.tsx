    ...
    <aside className="sticky top-32 py-5 lg:py-8">
      ...
      {neighborhood.isAvailable ? (
        <div className="mt-8">
          ...
          <details className="border-y border-navy/10 py-4"><summary className="flex cursor-pointer list-none items-center justify-between text-sm font-bold">Composition & démarche <ChevronDown className="h-4 w-4" /></summary><p className="pt-3 text-sm leading-6 text-navy/55">T-shirt blanc, 100 % coton, 165 g/m², col rond côtelé coton/Lycra® et doubles coutures aux manches et à la base. Chaque visuel est imaginé à Marseille, imprimé en DTF à Marseille et proposé en série courte.</p></details>
