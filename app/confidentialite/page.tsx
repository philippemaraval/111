  ...
  return (
    ...
    >
      ...
      <EditorialSection title="Pourquoi nous les utilisons">
        ...
        <p>Un vote permet également de vous informer si le quartier soutenu rejoint la collection. Nous n’utilisons pas votre adresse pour des communications sans rapport avec 111.</p>
      </EditorialSection>
