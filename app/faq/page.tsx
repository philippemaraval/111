...
const questions = [
  ...
  ["Comment fonctionne le vote ?", "Chaque quartier encore à imaginer possède son propre compteur. Un vote par adresse e-mail et par quartier est enregistré ; le classement nous aide à décider quels visuels développer ensuite. Dès qu’un tee-shirt passe en projet ou rejoint la collection, son compteur n’est plus affiché."],
